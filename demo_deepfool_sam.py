...
def make_examples():
    ...
    for i in range(6):
        ...
        image_rgb = cv2.cvtColor(np.array(original_images[0].permute(1, 2, 0)), cv2.COLOR_BGR2RGB)
    ...
    return original_images, original_labels, perturbed_images, perturbed_labels, max_pixel_values, diff_norms, region_masks
